  ...
  return (
    <section className="cta-final" id="download">
      <div className="cta-final-container">
        ...
        <span className="cta-final-label">
          COM CRISTO
        </span>

        <h2>
          Comece hoje o seu momento com Deus.
        </h2>

        <p>
          Tenha versículos, devocionais, Bíblia e conteúdos cristãos
          sempre com você.
        </p>
        ...
        <div className="cta-final-actions">
          ...
          <a
            ...
            className="cta-final-button cta-final-button-primary"
            target="_blank"
          ...
          <a
            ...
            className="cta-final-button cta-final-button-secondary"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
